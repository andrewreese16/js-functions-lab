...
// function convertTemperature(temp, c, f){
//     if (c === "C"){
//         return (temp * 9/5) + 32;
//     } else if (f === "F"){
//         return (temp - 32) * 5/9;
...
// console.log('Exercise 9 Result:', basicCalculator(10, 2, "divide"));
...
// console.log('Exercise 11 Result:', createUsername("Andrew", "Reese"));
